...
public class SystemController {
    ...
    public ResultMessage toUploadImagesOverride(@RequestParam("file") MultipartFile file, String imgName,
        ...
        try {
            ...
            // 获取上传文件的名字
            String fileName = StrUtil.format("images{}{}{}{}", File.separator, DateUtil.format(new Date(), "yyyy-MM"), File.separator, imgName + ".jpg");
            String filePath = StrUtil.format("{}{}resource.file{}{}", System.getProperty("user.dir"), File.separator, File.separator, fileName);
